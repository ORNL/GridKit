...
{
    /*!
     * @brief Implementation of a TGOV1 Turbine-Governor model.
     *
     */
    template  <class ScalarT, typename IdxT>
    class Governor : public ModelEvaluatorImpl<ScalarT, IdxT>
    {
    ...
    public:
        Governor(BaseBus<ScalarT, IdxT>* bus, ScalarT P0, ScalarT Q0);
        virtual ~Governor();
