  ...
  namespace PhasorDynamics
  {
    namespace Stabilizer
    {
      ...
      void Ieeest<scalar_type, index_type>::gatherExternalVariables()
      {
        ...
        y_ext_[U]                = ScalarT{ZERO<RealT>};
        variable_indices_ext_[U] = INVALID_INDEX<IdxT>;

        if (signals_.template isAttached<IeeestExternalVariables::U>())
        {
          y_ext_[U]                = signals_.template readExternalVariable<IeeestExternalVariables::U>();
          variable_indices_ext_[U] = signals_.template readExternalVariableIndex<IeeestExternalVariables::U>();
        }
      }
