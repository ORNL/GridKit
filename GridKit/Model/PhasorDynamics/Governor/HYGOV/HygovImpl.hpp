...
namespace GridKit
{
  namespace PhasorDynamics
  {
    namespace Governor
    {
      ...
      template <typename scalar_type, typename index_type>
      scalar_type Hygov<scalar_type, index_type>::toPmechBase(scalar_type value) const
      {
      ...
      void Hygov<scalar_type, index_type>::initModelParams(const ModelDataT& data)
      {
        ...
        load_required_real(Params::mva, pmech_mva_base_, "mva");
        load_required_real(Params::Rperm, Rperm_, "Rperm");
        load_required_real(Params::Rtemp, Rtemp_, "Rtemp");
        load_required_real(Params::Tr, Tr_, "Tr");
        load_required_real(Params::Tf, Tf_, "Tf");
        load_required_real(Params::Tg, Tg_, "Tg");
        load_required_real(Params::Velm, Velm_, "Velm");
        load_required_real(Params::Gmax, Gmax_, "Gmax");
        load_required_real(Params::Gmin, Gmin_, "Gmin");
        load_required_real(Params::Tw, Tw_, "Tw");
        load_required_real(Params::At, At_, "At");
        load_required_real(Params::Dturb, Dturb_, "Dturb");
        load_required_real(Params::Qnl, Qnl_, "Qnl");
        load_required_real(Params::Tn, Tn_, "Tn");
        load_required_real(Params::Tnp, Tnp_, "Tnp");
        load_required_real(Params::db1, db1_, "db1");
        load_optional_real(Params::db2, db2_, "db2");
        load_required_real(Params::Hdam, Hdam_, "Hdam");

        load_required_real(Params::Gv0, Gv_[0], "Gv0");
        load_required_real(Params::Gv1, Gv_[1], "Gv1");
        load_required_real(Params::Gv2, Gv_[2], "Gv2");
        load_required_real(Params::Gv3, Gv_[3], "Gv3");
        load_required_real(Params::Gv4, Gv_[4], "Gv4");
        load_required_real(Params::Gv5, Gv_[5], "Gv5");
        load_required_real(Params::Pgv0, Pgv_[0], "Pgv0");
        load_required_real(Params::Pgv1, Pgv_[1], "Pgv1");
        load_required_real(Params::Pgv2, Pgv_[2], "Pgv2");
        load_required_real(Params::Pgv3, Pgv_[3], "Pgv3");
        load_required_real(Params::Pgv4, Pgv_[4], "Pgv4");
        load_required_real(Params::Pgv5, Pgv_[5], "Pgv5");
