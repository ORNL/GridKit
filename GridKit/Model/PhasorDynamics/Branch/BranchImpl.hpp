...
namespace GridKit
{
  namespace PhasorDynamics
  {
    ...
    void Branch<scalar_type, index_type>::setDerivedParams()
    {
      ...
      g11_ = in_service_factor_ * (g_diag * inv_tap * inv_tap - RealT{0.5} * G_ - Gmag_);
      b11_ = in_service_factor_ * (b_diag * inv_tap * inv_tap - RealT{0.5} * B_ - Bmag_);
      ...
      g22_ = in_service_factor_ * (g_diag - RealT{0.5} * G_);
      b22_ = in_service_factor_ * (b_diag - RealT{0.5} * B_);
    }
