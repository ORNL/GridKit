...
namespace GridKit
{
  namespace PhasorDynamics
  {
        ...
        ScalarT*       f)
    {
      ...
      /* Genrou differential and zero-time-constant algebraic equations */
      ...
      f[5] = Tqop_ * Edp_dot - (-Edp + Xqd_ * psiqpp * ksat + Xq1_ * (iq - Xq3_ * (Edp + iq * Xq2_ - psiqp)));
