...
are specified:
  ...
  `Hygov`              | the HYGOV hydro turbine-governor model               | `pmech`, `speed`\*, `pref`\*, `paux`\* | `Trate`, `mva`, `Rperm`, `Rtemp`, `Tr`, `Tf`, `Tg`, `Velm`, `Gmax`, `Gmin`, `Tw`, `At`, `Dturb`, `Qnl`, `Tn`, `Tnp`, `db1`, `db2`, `Hdam`, `Gv0`-`Gv5`, `Pgv0`-`Pgv5` | `pmech`, `leadlag`, `filter`, `desiredgate`, `gate`, `flow`, `head`, `pgv`
