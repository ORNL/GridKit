...
specified:
  ...
  Bus class          | Description                                                | Variables available to monitor
  -------------------|------------------------------------------------------------|-------------------------------
...
State, then from the model default.
...
```json
{
   ...
   "buses": [
       { "number": 1, "class": "bus", "name": "Bus 1", "params": {"kv": 115.0}, "mon": ["Vr", "Vi"] },
       { "number": 2, "class": "infinite_bus", "name": "Bus 2", "params": {"kv": 115.0} }
   ],
   "signals": [
