...
namespace GridKit
{
  ...
  MicrogridLine<scalar_type, index_type>::MicrogridLine(IdxT id, RealT R, RealT L, NodeT* node_ref, NodeT* bus1, NodeT* bus2)
    : R_(R),
      L_(L),
      node_ref_(node_ref),
      bus1_(bus1),
  ...
  template <typename scalar_type, typename index_type>
  MicrogridLine<scalar_type, index_type>::~MicrogridLine()
  {
  }
   ...
   */
  template <typename scalar_type, typename index_type>
  int MicrogridLine<scalar_type, index_type>::initialize()
  {
    return 0;
  }
   ...
   */
  template <typename scalar_type, typename index_type>
  int MicrogridLine<scalar_type, index_type>::tagDifferentiable()
  {
    return 0;
  }
   ...
   */
  template <typename scalar_type, typename index_type>
  int MicrogridLine<scalar_type, index_type>::setAbsoluteTolerance(RealT rel_tol)
  {
   ...
   */
  template <typename scalar_type, typename index_type>
  int MicrogridLine<scalar_type, index_type>::evaluateInternalResidual()
  {
  ...
  template <typename scalar_type, typename index_type>
  int MicrogridLine<scalar_type, index_type>::evaluateExternalResidual()
  {
    auto* f = f_.getData();
   ...
   */
  template <typename scalar_type, typename index_type>
  int MicrogridLine<scalar_type, index_type>::evaluateJacobian()
  {
    this->zeroJacMatrix();
  ...
  template <typename scalar_type, typename index_type>
  int MicrogridLine<scalar_type, index_type>::allocate()
  {
  ...
  template <typename scalar_type, typename index_type>
  int MicrogridLine<scalar_type, index_type>::evaluateIntegrand()
  {
    return 0;
  }

  template <typename scalar_type, typename index_type>
  int MicrogridLine<scalar_type, index_type>::initializeAdjoint()
  {
    return 0;
  }

  template <typename scalar_type, typename index_type>
  int MicrogridLine<scalar_type, index_type>::evaluateAdjointResidual()
  {
    return 0;
  }

  template <typename scalar_type, typename index_type>
  int MicrogridLine<scalar_type, index_type>::evaluateAdjointIntegrand()
  {
    return 0;
  }
