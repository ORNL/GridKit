...
{
  /*!
   * @brief Declaration of a passive ComponentPartitionInterface class.
   *
   */
  template <class ScalarT, typename IdxT>
  class ComponentPartitionInterface : public PartitionInterface<ScalarT, IdxT>
  {
  ...
  public:
    ComponentPartitionInterface(CircuitComponent<ScalarT, IdxT>* component, IdxT bus_i, IdxT bus_j, IdxT id);
    virtual ~ComponentPartitionInterface();
