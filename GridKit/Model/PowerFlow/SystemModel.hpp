...
namespace GridKit
{
  ...
  class SystemModel : public ModelEvaluatorImpl<scalar_type, index_type>
  {
  ...
  public:
    ...
    using BusT       = Model::Evaluator<ScalarT, IdxT>;
    using ComponentT = Model::Evaluator<ScalarT, IdxT>;
