...
namespace GridKit
{
  namespace EMT
  {
    ...
    template <typename scalar_type, typename index_type>
    bool SignalNode<scalar_type, index_type>::residualLinked() const
    {
    ...
    template <typename scalar_type, typename index_type>
    void SignalNode<scalar_type, index_type>::accumulateResidual(ScalarT value)
    {
      *residual_ += value;
    }
    ...
    template <typename scalar_type, typename index_type>
    void SignalNode<scalar_type, index_type>::initDerivative(ScalarT derivative)
    {
      *derivative_ = derivative;
    }

    template <typename scalar_type, typename index_type>
    void SignalNode<scalar_type, index_type>::markDerivativeCoupling()
    {
      derivative_coupling_ = true;
    }

    template <typename scalar_type, typename index_type>
    bool SignalNode<scalar_type, index_type>::hasDerivativeCoupling() const
    {
