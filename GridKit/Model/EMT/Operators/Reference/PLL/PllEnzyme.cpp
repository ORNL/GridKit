...
namespace GridKit
{
  namespace EMT
  {
    ...
    int Pll<scalar_type, index_type>::assembleJacobian(RealT y_scale, RealT yp_scale)
    {
    ...
    template class Pll<double, long int>;
    template class Pll<double, size_t>;
