...
#include <GridKit/Model/EMT/Governor/Tgov1/Tgov1.hpp>
...
namespace GridKit
{
  namespace EMT
  {
    namespace Governor
    {
       ...
       * @param omega $\omega_r$ external variable signal node
       */
      template <typename scalar_type, typename index_type>
          ...
          Dt_(0)
      {
        ...
        signals_.template attachSignalNode<Tgov1ExternalVariables::OMEGA>(omega);
