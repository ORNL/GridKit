  ...
  namespace EMT
  {
    namespace Controller
    {
      ...
      enum class GastPtiInternalVariables : size_t
      {
        ...
        PMECH,  ///< \f$P_{\text{m}}\f$ Algebraic mechanical-power output on machine base [p.u.]
      ...
      {
        OMEGA,  ///< \f$\omega\f$ Absolute machine rotor speed (one at synchronous) [p.u.]
        PREF,   ///< \f$P^\mathrm{ref}\f$ Active-power/load reference on machine base [p.u.]
      ...
      private:
        ...
        RealT                                     toMachineBase(RealT value) const;
        ...
        RealT va_machine_base_{ZERO<RealT>}; ///< Required connected-machine rating in VA
