/**
 * @file OuterPowerControlEnzyme.cpp
...
namespace GridKit
{
  namespace EMT
  {
    namespace Controller
    {
      ...
      int OuterPowerControl<scalar_type, index_type>::assembleJacobian(RealT y_scale, RealT yp_scale)
      {
        ...
        using ModelT = OuterPowerControl<ScalarT, IdxT>;
