...
namespace GridKit
{
  namespace EMT
  {
    /// Internal variables of a `SynchronousMachine`
    enum class SynchronousMachineInternalVariables : size_t
    {
      THETA, ///< \f$\theta\f$
      OMEGA, ///< \f$\omega_r\f$
      PSID,  ///< \f$\psi_d\f$
    ...
    /// External variables of a `SynchronousMachine`
    enum class SynchronousMachineExternalVariables : size_t
    {
      VA,  ///< \f$v_a\f$
      VB,  ///< \f$v_b\f$
      VC,  ///< \f$v_c\f$
    ...
    class SynchronousMachine : public Component<scalar_type, index_type>
    {
    ...
    public:
      ...
      using ModelDataT = SynchronousMachineData<RealT, IdxT>;
      using SignalT    = SignalNode<ScalarT, IdxT>;
      using Port3T     = Port3<ScalarT, IdxT>;
      using MonitorT   = Model::VariableMonitor<SynchronousMachine, SynchronousMachineData>;

      SynchronousMachine();
      SynchronousMachine(const ModelDataT& data);
      ...
      auto getSignals() -> ComponentSignals<ScalarT,
                                            IdxT,
                                            SynchronousMachineInternalVariables,
                                            SynchronousMachineExternalVariables>&
      {
        return signals_;
      }
    ...
    private:
      ...
      ComponentSignals<ScalarT, IdxT, SynchronousMachineInternalVariables, SynchronousMachineExternalVariables> signals_;
