/**
 * @file SynchronousMachineData.hpp
...
namespace GridKit
{
  namespace EMT
  {
    ...
    enum class SynchronousMachineParameters
    {
      N,    ///< Number of phases
    ...
    enum class SynchronousMachineBuses : size_t
    {
    ...
    enum class SynchronousMachineSignalInputs : size_t
    {
    ...
    enum class SynchronousMachineSignalOutputs : size_t
    {
      speed, ///< Rotor speed
      SIZE
    };
    ...
    enum class SynchronousMachineMonitorableVariables
    {
      theta,
      omega,
      te,
    ...
    struct SynchronousMachineData : public ComponentData<real_type,
                                                         index_type,
                                                         SynchronousMachineParameters,
                                                         SynchronousMachineBuses,
                                                         SynchronousMachineSignalInputs,
                                                         SynchronousMachineSignalOutputs,
                                                         SynchronousMachineMonitorableVariables>
    {
      SynchronousMachineData() = default;

      using Parameters           = SynchronousMachineParameters;
      using Buses                = SynchronousMachineBuses;
      using SignalInputs         = SynchronousMachineSignalInputs;
      using SignalOutputs        = SynchronousMachineSignalOutputs;
      using MonitorableVariables = SynchronousMachineMonitorableVariables;
    };
  } // namespace EMT
} // namespace GridKit
