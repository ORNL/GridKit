...
`SynchronousMachine` represents an $N$-phase round-rotor synchronous machine
...
![SynchronousMachine model block diagram](../../../../../../docs/Figures/EMT/SynchronousMachine/diagram.png)

Figure 1: SynchronousMachine model
