 ...
 * @brief Declaration of the EMT dependent voltage source model.
 *
 */
...
namespace GridKit
{
  namespace EMT
  {
    ...
    struct DependentVoltageSourceData;
  } // namespace EMT
} // namespace GridKit
...
namespace GridKit
{
  namespace EMT
  {
    /// Internal variables of a `DependentVoltageSource`
    enum class DependentVoltageSourceInternalVariables : size_t
    {
      IA, ///< \f$i_a\f$
      IB, ///< \f$i_b\f$
      IC, ///< \f$i_c\f$
    ...
    /// External variables of a `DependentVoltageSource`
    enum class DependentVoltageSourceExternalVariables : size_t
    {
      VA, ///< \f$v_a\f$
      VB, ///< \f$v_b\f$
      VC, ///< \f$v_c\f$
    ...
    /*!
     * @brief Implementation of a three-phase EMT dependent voltage source.
     *
     * The source voltage is read from external signals. The terminal
     * admittance is represented by the series matrices or a rational fit.
     */
    template <typename scalar_type, typename index_type>
    class DependentVoltageSource : public Component<scalar_type, index_type>
    {
    ...
    public:
      ...
      DependentVoltageSource(const ModelDataT& data);
      virtual ~DependentVoltageSource();
      ...
      auto getSignals() -> ComponentSignals<ScalarT,
                                            IdxT,
                                            DependentVoltageSourceInternalVariables,
                                            DependentVoltageSourceExternalVariables>&
      {
        return signals_;
      }
