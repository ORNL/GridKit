...
namespace GridKit
{
  namespace EMT
  {
    ...
    int Machine<scalar_type, index_type>::assembleJacobian(RealT y_scale, RealT yp_scale)
    {
      ...
      using ModelT = Machine<ScalarT, IdxT>;
    ...
    template class Machine<double, long int>;
    template class Machine<double, size_t>;
