  ...
  namespace OPF
  {
    namespace
    {
                               ...
                               const std::string&                      context)
      {
        ...
        {
          if (!isKnownField(item.key(), known_fields))
          {
            throwParseError(context + "." + item.key(), "unknown field");
          }
        }
      }
                            ...
                            const std::string&    context)
      {
        ...
        result = parseReal(*item, context + "." + field);
      }
                              ...
                              const std::string& context)
      {
        ...
        return parseReal(*item, context + "." + field);
      }
                              ...
                              const std::string& context)
      {
        ...
        rejectUnknownFields(params, {"R", "X", "G", "B", "smax"}, context + ".params");
