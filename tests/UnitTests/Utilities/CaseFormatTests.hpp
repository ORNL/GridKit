  ...
  namespace Testing
  {
    ...
    public:
      ...
      TestOutcome signalParse()
      {
        ...
        success *= result.repca[0].signal_inputs[RepcaData::SignalInputs::pref] == 19;
