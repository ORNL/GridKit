  ...
  namespace Testing
  {
    ...
    public:
      ...
      TestOutcome simpleParse()
      {
        ...
        const char data[] =
            R"({
               ...
               "devices": [
                   { "class": "Branch", "ports": {"bus1":1, "bus2":2}, "id": "1", "params": {"R":0.0, "X":0.1, "G":0.0, "B":0.0, "Gmag":0.01, "Bmag":0.02, "tap":1.05, "phase":0.1, "closed":false} },
        ...
        success *= std::get<bool>(result.branch[0].parameters[BranchParameters::closed]) == false;
      ...
      TestOutcome signalParse()
      {
        ...
        const char data[] =
            R"({
               ...
               "devices": [
                   ...
                   { "class": "Tgov1", "ports": {"speed": 1, "pref":10, "pmech":2}, "id": "DV2", "params": {"R":0.05, "T1":0.5,"T2":2.5, "T3":7.5, "Pvmax":1.0, "Pvmin":0.0, "Dt":0.0}},
        ...
        success *= std::get<RealT>(result.gov[0].parameters[Governor::Tgov1Parameters::Pvmax]) == 1;
        success *= std::get<RealT>(result.gov[0].parameters[Governor::Tgov1Parameters::Pvmin]) == 0;
