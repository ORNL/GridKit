      ...
      TestOutcome simpleParse()
      {
        ...
        const char data[] =
            R"({
               ...
               "devices": [
                   { "class": "Branch", "ports": {"bus1":1, "bus2":2}, "id": "1", "params": {"R":0, "X":0.1, "G":0, "B":0, "tap":1.05, "phase":0, "closed": false} },
        ...
        success *= std::get<RealT>(result.branch[0].parameters[BranchParameters::phase]) == 0.0;
