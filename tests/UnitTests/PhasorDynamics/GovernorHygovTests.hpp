  ...
  namespace Testing
  {
    ...
    public:
      ...
      TestOutcome constructionAndValidation()
      {
        ...
        PhasorDynamics::Governor::Hygov<ScalarT, IdxT> source_default_hygov_model(source_default_hygov);
        success *= (source_default_hygov_model.verify() == 0);

        auto bad_hygov                                                       = makeHygovData();
        bad_hygov.parameters[PhasorDynamics::Governor::HygovParameters::db2] = static_cast<RealT>(0.01);
        ...
        PhasorDynamics::Governor::Hygov<ScalarT, IdxT> bad_hygov_leadlag_model(bad_hygov_leadlag);
        success *= (bad_hygov_leadlag_model.verify() > 0);

        auto bad_hygov_curve                                                       = makeHygovData();
        bad_hygov_curve.parameters[PhasorDynamics::Governor::HygovParameters::Gv2] = static_cast<RealT>(0.2);
      ...
      TestOutcome signals()
      {
        ...
        hygov_signals.template assignSignalNode<PhasorDynamics::Governor::HygovInternalVariables::PMECH>(
            &pmech_node);
        hygov_signals.template attachSignalNode<PhasorDynamics::Governor::HygovExternalVariables::OMEGA>(
            &omega_node);
      ...
      TestOutcome sourceDefault()
      {
        ...
        hygov.getSignals().template assignSignalNode<PhasorDynamics::Governor::HygovInternalVariables::PMECH>(
            &pmech_node);
  ...
  "devices": [
    ...
    },
    {
      ...
      "params": {
        ...
        const auto hygov_offset =
            static_cast<size_t>(system.size()
                                - static_cast<IdxT>(PhasorDynamics::Governor::HygovInternalVariables::MAXIMUM));
        success *= isEqual(system.y()[hygov_offset + index(PhasorDynamics::Governor::HygovInternalVariables::Q)],
                           static_cast<ScalarT>(0.70),
                           kTol);
        success *= isEqual(system.y()[hygov_offset + index(PhasorDynamics::Governor::HygovInternalVariables::G)],
                           static_cast<ScalarT>(0.70),
                           kTol);
