  ...
  namespace Testing
  {
    ...
    public:
      ...
      TestOutcome constructionAndValidation()
      {
        ...
        wide_band_reecb.parameters[PhasorDynamics::Converter::ReecbParameters::Vdip] = static_cast<RealT>(-99.0);
        wide_band_reecb.parameters[PhasorDynamics::Converter::ReecbParameters::Vup]  = static_cast<RealT>(99.0);
        PhasorDynamics::Converter::Reecb<ScalarT, IdxT> wide_band_reecb_model(&bus, wide_band_reecb);
        success *= (wide_band_reecb_model.verify() == 0);

        auto bad_reecb_band                                                         = makeReecbData();
        bad_reecb_band.parameters[PhasorDynamics::Converter::ReecbParameters::Vdip] = static_cast<RealT>(1.2);
        bad_reecb_band.parameters[PhasorDynamics::Converter::ReecbParameters::Vup]  = static_cast<RealT>(1.2);
        PhasorDynamics::Converter::Reecb<ScalarT, IdxT> bad_reecb_band_model(&bus, bad_reecb_band);
        success *= (bad_reecb_band_model.verify() > 0);

        auto bad_reecb                                                         = makeReecbData();
        bad_reecb.parameters[PhasorDynamics::Converter::ReecbParameters::Imax] = static_cast<RealT>(-1.0);
