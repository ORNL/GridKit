  ...
  namespace Testing
  {
    ...
    public:
      ...
      TestOutcome constructionAndValidation()
      {
        ...
        success *= (repca.size()
                    == static_cast<IdxT>(
                        PhasorDynamics::Converter::RepcaInternalVariables::MAXIMUM));
        ...
        bad_repca.parameters[PhasorDynamics::Converter::RepcaParameters::Tfv] =
  ...
  "devices": [
    {
      ...
      "params": {
        ...
        success   *= (data.repca[0].ports.at(PhasorDynamics::Converter::RepcaPorts::pbranch)
                    == 14);
        success   *= (data.repca[0].ports.at(PhasorDynamics::Converter::RepcaPorts::qbranch)
                    == 15);
