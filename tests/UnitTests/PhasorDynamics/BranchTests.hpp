  ...
  namespace Testing
  {
    ...
    public:
      ...
      TestOutcome outOfServiceBranch()
      {
        ...
        data.parameters[PhasorDynamics::BranchParameters::Gmag] = RealT{0.3};
        data.parameters[PhasorDynamics::BranchParameters::Bmag] = RealT{0.4};
        data.parameters[PhasorDynamics::BranchParameters::tap] = RealT{1.2};
        data.parameters[PhasorDynamics::BranchParameters::phase] = RealT{0.15};
