/**
 * @file MachineTests.hpp
 * @author Luke Lowery (lukel@tamu.edu)
 * @brief Machine model tests on a hand-assembled one-bus system.
 *
 */
#pragma once
...
namespace GridKit
{
  namespace Testing
  {
    ...
    public:
      ...
      MachineTests()  = default;
      ~MachineTests() = default;

    private:
      static GridKit::EMT::MachineData<ScalarT, IdxT> makeResidualData()
      {
        using Data      = GridKit::EMT::MachineData<ScalarT, IdxT>;
