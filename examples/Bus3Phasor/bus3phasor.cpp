...
int diff_gen(std::vector<double> Y, std::vector<double> &Yp,
             std::vector<double> Z, generator_params P, double P_mech,
             double E_fd) {
...
int get_algebraic_res(std::vector<double> &res, std::vector<double> Y,
                      std::vector<double> Z, std::vector<double> V,
                      std::vector<double> I, generator_params P, double R_a) {
  double delta = Y[_DEL1];
  double w = Y[_W1];
  double E_qp = Y[_E_qp1];
  double psi_dp = Y[_PSI_dp1];
 ...
 * V[3]: V_i2
 */
int brancheq(std::vector<double> &res, std::vector<double> &I,
             std::vector<double> &V, double g, double b, double G, double B) {
  res[0] =
 ...
 * V[1]: V_i1
 */
int loadeq(std::vector<double> &I, std::vector<double> &V,
           std::vector<double> &res, double R1, double R2) {
...
int copy_to_res_vector(std::vector<double> &gen_res,
                       std::vector<double> &towrite, int &at) {
...
int diff_res(double t, std::vector<double> &Y, std::vector<double> &Yp,
             generator_params params, std::vector<double> &gen_res) {
...
int main(int argc, char const *argv[]) {
  ...
  std::vector<double> Y = {1, 1,  2,  2,   2,   1,  1,  2, -6,  -5, 4,
  ...
  // std::cout << "\n--------------------Branches----------------------" <<
  // std::endl; double g, b, B, G; g = 1, b=1, G=2, B=2;
