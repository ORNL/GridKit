...
int main(int argc, char const* argv[])
{
    ...
    auto* sysmodel = new GridKit::PowerElectronicsModel<double, size_t>(
        rel_tol, abs_tol, use_jac);
    ...
    // inductor
    GridKit::Inductor<double, size_t>* induct =
        new GridKit::Inductor(idoff, linit);
    ...
    // resistor
    idoff++;
    GridKit::Resistor<double, size_t>* resis =
        new GridKit::Resistor(idoff, rinit);
    // Form index to node uid realations
    // input
    ...
    // voltage source
    idoff++;
    GridKit::VoltageSource<double, size_t>* vsource =
        new GridKit::VoltageSource(idoff, vinit);
    // Form index to node uid realations
    // input
