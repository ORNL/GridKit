...
python3 examples/PhasorDynamics/plotting/plot_bus_frequency.py \
  build/examples/PhasorDynamics/DynamicSimulation/ACTIVSg25k/ACTIVSg25k.plot.solver.json \
  --output examples/PhasorDynamics/DynamicSimulation/ACTIVSg25k/ACTIVSg25k_bus_frequency.png

python3 examples/PhasorDynamics/plotting/plot_adaptive_step.py \
  build/examples/PhasorDynamics/DynamicSimulation/ACTIVSg10k/ACTIVSg10k.plot.solver.json \
  build/examples/PhasorDynamics/DynamicSimulation/ACTIVSg25k/ACTIVSg25k.plot.solver.json \
  build/examples/PhasorDynamics/DynamicSimulation/ACTIVSg70k/ACTIVSg70k.plot.solver.json \
