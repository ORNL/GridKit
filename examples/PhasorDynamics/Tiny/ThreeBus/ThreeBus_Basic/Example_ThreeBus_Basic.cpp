/**
 * @file Example_ThreeBus_Basic.cpp
 ...
 *
 */
#include "Example_ThreeBus_Basic.hpp"
...
struct OutputData
{
  ...
  {
    assert(GridKit::Testing::isEqual(t, other.t, Example_ThreeBus_Basic::reference_tol));
...
int main()
{
  ...
  std::cout << "Example_ThreeBus_Basic\n";
  ...
  {
    OutputData ref{Example_ThreeBus_Basic::reference_solution[i + 1][0],
                   Example_ThreeBus_Basic::reference_solution[i + 1][1],
                   Example_ThreeBus_Basic::reference_solution[i + 1][2],
                   Example_ThreeBus_Basic::reference_solution[i + 1][4],
                   Example_ThreeBus_Basic::reference_solution[i + 1][5]};
