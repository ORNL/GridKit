 ...
 *
 */
#include "Example_TwoBus_Basic.hpp"
...
int main()
{
  ...
  for (size_t i = 0; i < output.size(); i++)
  {
    ...
    std::vector<real_type>& ref_sol = Example_TwoBus_Basic::reference_solution[i + 1];
