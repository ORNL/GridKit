...
int main()
{
  ...
  GenClassical<scalar_type, index_type> gen2(genData(0.5, -0.00442101));
  GenClassical<scalar_type, index_type> gen3(genData(0.5, -0.02510812));
  GenClassical<scalar_type, index_type> gen4(genData(0.5, -0.04339553));
  GenClassical<scalar_type, index_type> gen5(genData(0.5, -0.2334993));
  GenClassical<scalar_type, index_type> gen6(genData(0.5, 0.69907194));
  GenClassical<scalar_type, index_type> gen7(genData(0.5, -0.08318208));
  GenClassical<scalar_type, index_type> gen8(genData(0.5, -0.09123614));
  GenClassical<scalar_type, index_type> gen9(genData(0.5, -0.09662372));
  GenClassical<scalar_type, index_type> gen10(genData(0.5, -0.09932297));
