...
int main()
{
  ...
  GenClassical<scalar_type, index_type> gen2(&bus2, 3., 0.1, 0., 0.2);
  GenClassical<scalar_type, index_type> gen3(&bus3, 3., 0.1, 0., 0.2);
  GenClassical<scalar_type, index_type> gen4(&bus4, 3., 0.1, 0., 0.2);
  GenClassical<scalar_type, index_type> gen5(&bus5, 3., 0.1, 0., 0.2);
  GenClassical<scalar_type, index_type> gen6(&bus6, 3., 0.1, 0., 0.2);
  GenClassical<scalar_type, index_type> gen7(&bus7, 3., 0.1, 0., 0.2);
  GenClassical<scalar_type, index_type> gen8(&bus8, 3., 0.1, 0., 0.2);
  GenClassical<scalar_type, index_type> gen9(&bus9, 3., 0.1, 0., 0.2);
  GenClassical<scalar_type, index_type> gen10(&bus10, 3., 0.1, 0., 0.2);
  ...
  std::array<GenClassical<scalar_type, index_type>*, 9> generators{
