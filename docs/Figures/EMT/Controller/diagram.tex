...
\node[signal, label={[sig]above:$\mathbf{i}_g$}] (igabc)
    at (\ifgfm 16.15\else 15.65\fi, 0) {};
...
\draw[->, line] (igabc) -- ([xshift=\ifgfm 2.5mm\else -2.5mm\fi]outer.north);
...
\ifgfm\else
\node[signal] (vterminal) at (20,-1.6) {};
\draw[->, line] (vterminal) -- (16.15,-1.6) -- ([xshift=2.5mm]outer.north);
\fi
