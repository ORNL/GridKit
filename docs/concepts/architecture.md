...
| --- | --- | --- |
| Applications | Configure and run simulations and analyses. | [Apps](../application/README.md) |
| Cases | Systems and model instances. | [Cases](../cases/index.md) |
| Models | Equations, parameters, ports, initialization, and outputs. | [Models](../GridKit/Model/README.md) |
| Solvers | Dynamic integration and steady-state solution. | [API](../api.md) |
