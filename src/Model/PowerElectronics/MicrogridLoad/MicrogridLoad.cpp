 ...
 *
 * Model is from paper: "
    "Modeling, Analysis and Testing of Autonomous Operation of an Inverter-Based Microgrid" Nagaraju Pogaku, Milan
 Prodanovic, and Timothy C. Green"
 * Section D
 */

template <class ScalarT, typename IdxT>
MicrogridLoad<ScalarT, IdxT>::MicrogridLoad(IdxT id, ScalarT R, ScalarT L) : R_(R), L_(L)
{
    // internals [id, iq]
