...
int SynchronousMachine<ScalarT, IdxT>::evaluateResidual()
{
    ...
    f_[3] = RJ_ * yp_[4]
            - (3.0 / 4.0) * P_
                  * (Lmd_ * y_[6] * (y_[7] + y_[11] + y_[12])
                     - Lmq_ * y_[7] * (y_[6] + y_[9] + y_[0]));
    f_[4] = yp_[5] - y_[4];
    f_[5] = (-2.0 / 3.0) * (y_[0] * cos1 + y_[1] * cos23m + y_[2] * cos23p)
            + Rs_ * y_[6] + (Lls_ + Lmq_) * yp_[6] + Lmq_ * yp_[9]
            + Lmq_ * yp_[10]
            + y_[4] * (P_ / 2.0)
                  * ((Lls_ + Lmd_) * y_[7] + Lmd_ * y_[11] + Lmd_ * y_[12]);
    f_[6] = (-2.0 / 3.0) * (y_[0] * sin1 - y_[1] * sin23m - y_[2] * sin23p)
            + Rs_ * y_[7] + (Lls_ + Lmd_) * yp_[7] + Lmd_ * yp_[11]
            + Lmd_ * yp_[12]
            - y_[4] * (P_ / 2.0)
                  * ((Lls_ + Lmq_) * y_[6] + Lmq_ * y_[9] + Lmq_ * y_[10]);
    f_[7] =
        (-1.0 / 3.0) * (y_[0] + y_[1] + y_[2]) + Rs_ * y_[8] + Lls_ * yp_[8];
    f_[8] =
        rkq1 * y_[9] + (llkq1 + Lmq_) * yp_[9] + Lmq_ * yp_[6] + Lmq_ * yp_[10];
    f_[9] =
        rkq1 * y_[9] + (llkq1 + Lmq_) * yp_[9] + Lmq_ * yp_[6] + Lmq_ * yp_[10];
    return 0;
}
