 ...
 * This model has "Virtual resistors". The voltage of the bus divided by its
 * virtual resistance. The components are external to allow for outside
 * components to add inductances to the terms.
 *
