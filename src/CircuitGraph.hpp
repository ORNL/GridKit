 ...
 *
 * @todo This is to replace inserting vector size for allocating
...
void CircuitGraph<N, E>::printBiPartiteGraph(bool verbose)
{
    ...
    std::cout << "Amount of HyperNodes: " << this->amountHyperNodes()
              << std::endl;
    std::cout << "Amount of HyperEdges: " << this->amountHyperEdges()
              << std::endl;
