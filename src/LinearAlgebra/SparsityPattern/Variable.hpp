...
namespace Sparse
{
    ...
    */
    ...
    public:
        ...
        */
        Variable()
            : value_(0.0), variable_number_(INVALID_VAR_NUMBER), is_fixed_(false), dependencies_(new DependencyMap)
        {
        }
        ...
        */
        explicit Variable(double value)
            : value_(value), variable_number_(INVALID_VAR_NUMBER), is_fixed_(false), dependencies_(new DependencyMap)
        {
        }
        ...
        */
        Variable(double value, size_t variable_number)
            : value_(value), variable_number_(variable_number), is_fixed_(false), dependencies_(new DependencyMap)
        {
