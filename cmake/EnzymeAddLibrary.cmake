...
macro(enzyme_build_object)
  ...
  foreach(SRC ${enzyme_build_object_SOURCES})
    ...
    add_custom_command(
      ...
      OUTPUT ${PHASE1}
      COMMAND
        ${CMAKE_CXX_COMPILER} -flto -c ${PHASE0} ${INCLUDE_COMPILER_LIST} -O2 -fno-vectorize
        -ffast-math -fno-unroll-loops -fpass-plugin=${ENZYME_CLANG_PLUGIN_LIBRARY} -Xclang -load
        -Xclang ${ENZYME_CLANG_PLUGIN_LIBRARY} -mllvm -enable-load-pre=0 -mllvm
        -enzyme-auto-sparsity=1 -o ${PHASE1}
  ...
  add_custom_command(
    ...
    OUTPUT ${PHASE3}
    COMMAND
      ${GRIDKIT_OPT} ${PHASE2} -load-pass-plugin=${ENZYME_LLVM_PLUGIN_LIBRARY} -passes=enzyme -o
      ${PHASE3} -S
